<template>
    <div>
        <div v-show="state.edit === false">
            <input type="checkbox" v-model="data.finished" @click="updateTodo">
        ...
        <div class="flex items-center w-full" v-show="state.edit === true">
            <input v-model="data.text" @keyup.enter="updateTodo" placeholder="Update Todo">
            <button @click="updateTodo" :disabled="data.text.length === 0">Update</button>
